...
# Below is the revised code chunk using piping for the task above

pipedmysample <- mysample %>%
  arrange(airline) %>%
...
# To check if the results are the same, we can use identical function below

identical(pipedmysample, mysample4)
